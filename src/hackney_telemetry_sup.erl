...
-define(
  PER_HOST,
  [nb_requests, request_time, connect_time, response_time, connect_timeout, connect_error]
).
...
init([]) ->
  ...
  ChildSpecs =
    ...
    ++
    [hackney_telemetry_worker:child_spec([{metric, [hackney_host, Sub]}]) || Sub <- ?PER_HOST],
